...
# 	Fix and test
# '''
# output_crisp = pd.read_csv("..\\resources\\results\\output-crisp.csv", sep=";", names=['Index', 'Original', 'Prediction'])
#
...
#
# plt.title("ComparaStochDom")
# plt.xlabel("Index")
# plt.ylabel("Value")
# plt.show()
# plt.savefig("..\\resources\\results\\solution3.png")
